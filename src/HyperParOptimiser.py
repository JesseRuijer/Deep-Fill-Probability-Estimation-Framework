...
if __name__ == '__main__':
    ...
    study = optuna.create_study(direction = 'maximize') # Since our criterion for finetuning is Precision Recall we aim to maximisze
    study.optimize(objective_lgbm, n_trials = 60)
